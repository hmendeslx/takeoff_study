...
# -Off and Landing-> One Case Study
...
## Test graphic
#  plot(flightdata$GS,type = "l",col="red")
...
#   
 ...
 ##$##
  plot(flightdata$GS,type = "l",col="blue", ylab = "Ground Speed", xlab = "Time [sec]")
  grid(,,col="red")
  ...
  png("test_GS.png")
  p <- qplot(time, GS, data=flightdata,  col=I("blue"),
